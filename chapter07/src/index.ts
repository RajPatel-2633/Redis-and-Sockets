...
const redis = new Redis({host:'localhost',port:Number(6379)}); // This is just for reading and writing

const publisher = new Redis({host:'localhost',port:Number(6379)}); // This is for publishing
const subscriber = new Redis({host:'localhost',port:Number(6379)}); // This is for subscribing
